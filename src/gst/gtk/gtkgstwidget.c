...
gtk_gst_custom_widget_draw (GtkWidget * widget, cairo_t * cr)
{
  ...
  GTK_GST_BASE_CUSTOM_WIDGET_LOCK (gst_widget);
  ...
  GTK_GST_BASE_CUSTOM_WIDGET_UNLOCK (gst_widget);
  return FALSE;
}

static void
gtk_gst_custom_widget_finalize (GObject * object)
{
  gtk_gst_base_custom_widget_finalize (object);

  G_OBJECT_CLASS (gtk_gst_custom_widget_parent_class)->finalize (object);
}

static void
gtk_gst_custom_widget_class_init (GtkGstCustomWidgetClass * klass)
{
  GObjectClass *gobject_klass = (GObjectClass *) klass;
  GtkWidgetClass *widget_klass = (GtkWidgetClass *) klass;

  gtk_gst_base_custom_widget_class_init (GTK_GST_BASE_CUSTOM_WIDGET_CLASS (klass));
  gobject_klass->finalize = gtk_gst_custom_widget_finalize;
  widget_klass->draw = gtk_gst_custom_widget_draw;
}

static void
gtk_gst_custom_widget_init (GtkGstCustomWidget * widget)
{
  gtk_gst_base_custom_widget_init (GTK_GST_BASE_CUSTOM_WIDGET (widget));
}

GtkWidget *
gtk_gst_custom_widget_new (void)
{
  return (GtkWidget *) g_object_new (GTK_TYPE_GST_CUSTOM_WIDGET, NULL);
}
